...
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_PRIMARY", "Основное действие")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_SECONDARY", "Вторичное действие")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_TERTIARY", "Третичное действие")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_QUATERNARY", "Четвертое действие")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_QUINARY", "Пятое действие")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_NEGATIVE", "Назад/Отмена")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_LEFT_SHOULDER", "Левый бампер")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_RIGHT_SHOULDER", "Правый бампер")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_LEFT_TRIGGER", "Левый триггер")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_RIGHT_TRIGGER", "Правый триггер")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_LEFT_STICK", "Левый стик")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_RIGHT_STICK", "Правый стик")
ZO_CreateStringId("SI_BINDING_NAME_BETTERUI_UI_MARK_JUNK", "Пометить как хлам")
